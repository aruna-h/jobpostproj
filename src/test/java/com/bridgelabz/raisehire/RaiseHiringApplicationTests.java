package com.bridgelabz.raisehire;
...
@SpringBootTest
@ContextConfiguration(classes = RaiseHiringApplication.class)
public class RaiseHiringApplicationTests {
	...
	@Test
	public void AddJobPostTest() throws Exception {
		Json json = cases.get("AddJobPost");
	...
	@Test
	public void AddJobSkillsTest() throws Exception {
		Json json = cases.get("AddJobSkills");
		System.out.println(json.getRequest());
		System.out.println(json.getRequest().getBody());
		test(json);
	}
	...
	@Test
	public void AddJobLocationTest() throws Exception {
		Json json = cases.get("AddJobLocation");
		System.out.println(json.getRequest());
		System.out.println(json.getRequest().getBody());
		test(json);
	}
	...
	@Test
	public void JobRoleStringTest() throws Exception {
		Json json = cases.get("JobRoleString");
		System.out.println(json.getRequest());
		System.out.println(json.getRequest().getBody());
		test(json);
	}
	...
	@Test
	public void JobExp_reqTest() throws Exception {
		Json json = cases.get("JobExp_req");
		System.out.println(json.getRequest());
		System.out.println(json.getRequest().getBody());
		test(json);
	}
